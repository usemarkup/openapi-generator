...
public class PhpMarkupServerCodegen extends AbstractPhpCodegen implements CodegenConfig {
    @SuppressWarnings("hiding")
    private static final Logger LOGGER = LoggerFactory.getLogger(PhpMarkupServerCodegen.class);
    ...
    protected String apiHandlerDirName = "Api\\Handler";
    ...
    public PhpMarkupServerCodegen() {
        ...
        apiTemplateFiles.put("api_handler.mustache", "Interface.php");
        ...
        embeddedTemplateDir = templateDir = "php-markup";
    ...
    public String apiHandlerFileFolder() {
        return (outputFolder + File.separator + toSrcPath(apiHandlerPackage, srcBasePath));
    }
    ...
    public String apiFilename(String templateName, String tag) {
        ...
        if (templateName.equals("api_handler.mustache"))
            return apiHandlerFileFolder() + File.separator + toApiHandlerName(tag) + suffix;
    ...
    public void processOpts() {
        ...
        additionalProperties.put("apiHandlerPackage", apiHandlerPackage);
    ...
    public void setInvokerPackage(String invokerPackage) {
        ...
        apiHandlerPackage = invokerPackage + "\\" + apiHandlerDirName;
    }
    ...
    protected String toApiHandlerName(String name) {
        if (name.isEmpty()) {
            return "DefaultHandler";
        }
        return camelize(name, false) + "HandlerInterface";
    }
